  ...
  connectedCallback() {
    ...
    this.innerHTML = `
      <a href="./index.html" class="nav-logo">
        <svg width="188" height="50" viewBox="0 0 210 56" fill="none" xmlns="http://www.w3.org/2000/svg">
          <text x="0" y="26" font-family="Montserrat,Arial,sans-serif" font-weight="700" font-size="22" letter-spacing="1.2" fill="#FFFFFF">BERRÍOS</text>
          <text x="0" y="47" font-family="Montserrat,Arial,sans-serif" font-weight="700" font-size="22" letter-spacing="1.2" fill="#FFFFFF">PALAVECINO</text>
        </svg>
      </a>
          ...
          <div>
            <div class="footer-logo-wrap">
              <svg viewBox="0 0 310 310" width="127" height="127" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="28" y="147" font-family="Montserrat,Arial,sans-serif" font-weight="700" font-size="36" fill="#FFFFFF" letter-spacing="1.2">BERRÍOS</text>
                <text x="28" y="182" font-family="Montserrat,Arial,sans-serif" font-weight="700" font-size="36" fill="#FFFFFF" letter-spacing="1.2">PALAVECINO</text>
              </svg>
            </div>
          </div>
          <div>
